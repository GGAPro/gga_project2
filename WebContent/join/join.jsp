...
<body>
	...
	<div class="join_title">
		<img src="http://localhost:9000/gga_test1/images/jointitle.png">
		</div>
	<section class="join">
			<form name="joinForm" action="#" method="get">
				<ul>
					...
					<div class="joinbtn">
						<a href= "http://localhost:9000/gga_test1/login/login.jsp">
						<img src="http://localhost:9000/gga_test1/images/joinbtn2.png"></a>
						<a href= "http://localhost:9000/gga_test1/join/join.jsp">
						<img src="http://localhost:9000/gga_test1/images/resetbtn.png"></a>
					</div>			
			</form>
		</section>
	</div>
