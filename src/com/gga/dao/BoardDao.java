...
public class BoardDao extends DBConn {
	...
	public int update(BoardVo boardVo) {
		int result = 0;
		String sql = "UPDATE BOARD SET BTITLE=? , MOVIENAME=?, SCORE=?, BCONTENT=? WHERE BID=? ";
	...
	public BoardVo select(String bid) {
		...
		String sql = "SELECT BID,BTITLE,SCORE,BCONTNET,VIEWS,MID,MOVIENAME,BDATE FROM BOARD WHERE BID=?";
		getPreparedStatement(sql);
	...
	public int insert(BoardVo boardVo) {
		int result = 0;
		String sql = "INSERT INTO BOARD(BID,BTITLE,SCORE,BCONTENT,VIEWS,MID,MOVIENAME,TO_CHAR(BDATE, 'YYYY-MM-DD') BDATE "
	...
	public ArrayList<BoardVo> select(){
		...
		String sql = "SELECT RNO, BID, BTITLE, BCONTENT, VIEWS, MID, MOVIENAME, TO_CHAR(BDATE, 'YYYY-MM-DD') BDATE FROM "
				+ " (SELECT BID, BTITLE, BCONTENT, VIEWS, MID, MOVIENAME, BDATE FROM BOARD ORDER BY BDATE DESC)";
		getPreparedStatement(sql);
